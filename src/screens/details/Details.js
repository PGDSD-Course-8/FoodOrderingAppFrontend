...
class Details extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <div> <Header showSearch="false" baseUrl={this.props.baseUrl} /> </div>
          ...
          <div className="cart">
            <div style={{ padding: '3%' }}>
              <Card className={classes.card}>
                ...
                <CardActions>
                  <div style={{ width: "100%" }}>
                    <Button style={{ width: "100%" }} color="primary" variant="contained"  onClick={this.checkoutHandler}> CHECKOUT </Button>
                  </div>
                </CardActions>
              </Card>
            </div>
        ...
        <Snackbar
          ...
          onClose={(e) => this.SnackBarHandler("")}
          ContentProps={{
            'aria-describedby': 'message-id' }}
          message={<span id="message-id">{this.state.snackbarMessage}</span>}
          action={[
            <IconButton
              onClick={(e) => this.SnackBarHandler("")}
              key="close"
              aria-label="Close"
              color="inherit" >
              <CloseIcon />
  ...
  onRemovingItemFromCart = (cartItem) => {
    let cartItemsList = this.state.cartItemsList;
    ...
    return (
      <div style={{ display: "flex", flexDirection: "row", width: "100%", paddingLeft: "1%" }}>
        ...
        <div style={{ width: "10%", display: "flex", alignItems: "center" }}>
          <IconButton onClick={(e) => props.this.onAddingItem(props.item)}><Add style={{ height: "100%" }} /></IconButton>
        </div>
      </div>
    )
  };
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row", width: "100%", padding: "1%" }}>
      ...
      <div style={{ width: "5%", display: "flex", alignItems: "center" }}>
        <i onClick={(e) => props.this.onRemovingItemFromCart(cartItem)} className="cartButton fa fa-minus" aria-hidden="true" ></i>
      </div>
      <div style={{ width: "5%", display: "flex", alignItems: "center" }}> {cartItem.quantity} </div>
      <div style={{ width: "25%", display: "flex", alignItems: "center" }}>
        <i onClick={(e) => props.this.onAddingItemFromCart(cartItem)} className="cartButton fa fa-plus" aria-hidden="true" ></i>
      </div>
